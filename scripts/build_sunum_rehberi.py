...
<div class="app-container">
  ...
  <header class="hero-header">
    ...
    <div class="meta-bar">
      ...
      <span>📑 <strong>Kalıcı DOI:</strong> <a href="https://doi.org/10.5281/zenodo.22802921" target="_blank">10.5281/zenodo.22802921</a></span>
  ...
  <article class="chapter-card" id="bolum8">
    ...
    <div class="card-mini" style="margin-bottom: 14px;">
      ...
      <p><strong>🗣️ Halka Cevap:</strong> "Evet! Uluslararası IEEE iki sütunlu akademik makale formatında hazırlanmış, bağımsız açık bilim arşivi CERN / Zenodo üzerinde kalıcı 10.5281/zenodo.22802921 DOI numarası ile tüm dünyaya tescillenmiştir. Kodlarımız ve canlı testlerimiz herkese açıktır."</p>
  ...
  <footer class="app-footer">
    ...
    <p style="margin-top: 10px; font-size: 11.5px;">
      Açık Bilim ve Teknoloji Mirası &bull; Kalıcı DOI: <a href="https://doi.org/10.5281/zenodo.22802921" target="_blank">10.5281/zenodo.22802921</a> &bull; MIT Lisansı
    </p>
  </footer>
