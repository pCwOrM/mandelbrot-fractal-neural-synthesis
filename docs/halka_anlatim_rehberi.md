...
1. **1. Dakika (Giriş & Şaşırtma):** `fraktal_noron_halk_arayuzu.html` sayfasını açın. *"Bugün size trilyonlarca baytlık hafıza kartları olmadan, sadece 24 baytla karar veren bir zeka hücresi göstereceğim"* deyin. Sağ üstteki Koyu/Açık mod butonuna basarak modernliği vurgulayın.
