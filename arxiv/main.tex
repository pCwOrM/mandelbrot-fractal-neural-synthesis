...
\begin{itemize}
    ...
    \item \textbf{Interactive Demonstration Lab:} \url{https://itouch.com.tr/lib/neural-synthesis/interactive_lab.html}
\end{itemize}
