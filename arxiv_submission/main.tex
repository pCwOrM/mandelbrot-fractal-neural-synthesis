...
\author{
    \textbf{Volkan Dağlı}\textsuperscript{1,*} \quad \textbf{Dr. Zerrin Dağlı}\textsuperscript{2} \\
    \textsuperscript{1}\textit{ITouch Bilişim Sistemleri (ITouch Systems), Turkey} \\
    \texttt{vdagli@aof.anadolu.edu.tr} \quad \url{https://itouch.com.tr} \\
    \textsuperscript{2}\textit{Department of Computer Education and Instructional Technology, Mersin University, Turkey} \\
    \textit{ORCID: 0000-0001-9490-6465} \quad \texttt{21010190002@mersin.edu.tr} \\
    \textsuperscript{*}\textit{Corresponding Author (arXiv: itouch, Co-author arXiv: jesmaat)}
}
...
\begin{equation}
\text{Memory Footprint} = 3 \times 8 \text{ bytes} = 24 \text{ Bytes}
\end{equation}
